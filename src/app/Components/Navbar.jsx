        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center">
            <Link href="/" aria-label="Home - CodewareIT">
              <Image src="/logo.png" width={80} height={90} alt="CodewareIT Logo" priority className="pt-1" />
            </Link>
          ...
          <ul className="hidden md:flex space-x-8 text-white items-center" role="menubar">
            <li role="none">
              <Link href="/Aboutus" className="hover:text-blue-400 transition-colors text-sm font-medium">About Us</Link>
            </li>
                ...
                <div className="absolute top-full left-1/2 -translate-x-1/2 mt-0 z-50" role="menu" aria-label="Courses mega menu" onMouseEnter={() => handleMouseEnter("Courses")} onMouseLeave={handleMouseLeave}>
                  <div className="bg-[#0A1C55] border border-white/10 rounded-2xl shadow-2xl p-5 mt-1 w-[680px] grid grid-cols-2 gap-4">
                    ...
                    <div className="col-span-2 border-t border-white/10 pt-3 flex gap-4">
                      <Link href="/Coursescoding" onClick={() => setOpenMenu(null)} className="text-xs text-blue-400 hover:text-blue-300 transition-colors">→ All Coding Courses</Link>
            ...
            <li role="none"><Link href="/intern" className="hover:text-blue-400 transition-colors text-sm font-medium">Internship</Link></li>
            <li role="none"><Link href="/Students" className="hover:text-blue-400 transition-colors text-sm font-medium">Students</Link></li>
            <li role="none">
      ...
      {isOpen && (
        <div id="mobile-menu" className="fixed top-[5rem] left-0 w-full h-screen bg-[#040A26] z-50 p-4 md:hidden overflow-y-auto" role="menu">
          <ul className="text-white space-y-2">
            <MobileLink href="/Aboutus" icon="ℹ️" label="About Us" onClick={toggleMobileMenu} />
            ...
            <MobileLink href="/intern" icon="🧑‍💼" label="Internship" onClick={toggleMobileMenu} />
            <MobileLink href="/Students" icon="👨‍🎓" label="Students" onClick={toggleMobileMenu} />
